...
basedir=default" > /var/tmp/vanagon-noask;
  ...
  /opt/csw/bin/pkgutil -y -i coreutils curl rsync gmake pkgconfig ggrep gsed;
  ...
  ln -sf /opt/csw/bin/greadlink /usr/bin/readlink;
  ln -sf /opt/csw/bin/gmake /usr/bin/make;
